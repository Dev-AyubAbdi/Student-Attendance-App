      ...
      <div className="flex gap-10 mt-6">
        <div className="bg-green-400 w-100 p-5 rounded-lg text-white ">
          <div className="pl-4 flex items-center">
             <IoMdCheckmark className="text-blue-500 bg-white rounded-full mr-7" size={50} />
            <div>
              <span className="text-2xl">
              Present Students</span>
        ...
        <div className="bg-red-400 w-100 p-5 rounded-lg text-white ">
          <div className="pl-4 flex items-center">
             <IoMdClose className="text-red-500 font-bold bg-white rounded-full mr-7" size={50} />
            <div>
              <span className="text-2xl">
              Absent Students</span>
            <p className="text-center text-4xl font-semibold">20</p>
            </div>
          </div>
        </div>
        <div className="bg-blue-400 w-100 p-5 rounded-lg text-white ">
          <div className="pl-4 flex items-center">
             <CiTimer className="text-blue-500 bg-white rounded-full mr-7" size={50} />
            <div>
              <span className="text-2xl">
              Late Students</span>
            <p className="text-center text-4xl font-semibold">20</p>
